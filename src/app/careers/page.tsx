    ...
    <div>
      ...
      <main className="flex text-left px-20 w-full min-h-screen flex flex-col items-start justify-center px-4">
        ...
        <h3 className="text-xl md:text-2xl text-white z-10 font-bold">
          Join our team of pioneers transforming the way insurance is bought and
          sold
        </h3>
      </main>
      ...
      <section className="bg-[#f0fdff] py-10">
        <div className="flex gap-4 px-20 animate-scroll whitespace-nowrap">
          <div className="flex flex-col gap-2 w-[180px] flex-shrink-0">
            <img src="/values/value1.jpg" className="rounded-lg" />
            <img src="/values/value2.jpg" className="rounded-lg" />
          </div>
          <img src="/values/value3.jpg" className="h-[240px] rounded-lg flex-shrink-0" />
          <div className="flex flex-col gap-2 w-[180px] flex-shrink-0">
            <img src="/values/value4.jpg" className="rounded-lg" />
            <img src="/values/value3.jpg" className="rounded-lg" />
          </div>
          <img src="/values/value1.jpg" className="h-[240px] rounded-lg flex-shrink-0" />
        </div>
      </section>
